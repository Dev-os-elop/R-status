...
func pngData(pixelSize: Int) -> Data {
    ...
    let cat = tile.insetBy(dx: size * 0.10, dy: size * 0.09)
    ...
    head.addCurve(to: point(0.16, 0.86), control1: point(0.13, 0.69), control2: point(0.13, 0.83))
    head.addCurve(to: point(0.38, 0.72), control1: point(0.20, 0.88), control2: point(0.30, 0.78))
    head.addCurve(to: point(0.62, 0.72), control1: point(0.45, 0.76), control2: point(0.55, 0.76))
    head.addCurve(to: point(0.84, 0.86), control1: point(0.70, 0.78), control2: point(0.80, 0.88))
    head.addCurve(to: point(0.85, 0.58), control1: point(0.87, 0.83), control2: point(0.87, 0.69))
